        ...
        <div className='header-home'>
            <div className='row'>
                ...
                <div className='label-holder'>
                    ...
                    <input className='input' type='text' id='search' text placeholder='Search for food, coffe, etc..' />
                </div>
            ...
            <div className='menu'>
                <Link
                    className={`menu-link ${activeDishes == '/' ? 'active-page' : ''}`}
                    onClick={() => setActiveDishes("/")}
                    to='/'>
                    Hot Dishes
         </Link>
                <Link
